...
# COCO 81 classes for 20_i 4 folds; VOC 21 classes 5_i folds. * each key for rest label.
# Models are trained on 3 splits and evaluated on the rest one in a cross-validation fashion.
CLASS_LABELS = {
    'VOC': {
        'all': set(range(1, 21)),
